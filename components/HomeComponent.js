...
const HomeComponent = () => {
  return (
    <Layout title="B2 Oil">
      ...
      <div className="w-full h-[18vh] md:h-[15vh]  bg-gradient-to-r from-green-100 to-orange-200 items-center relative flex justify-center">
      ...
      <div className="pt-8 px-4 grid md:grid-cols-2 md:mx-5 gap-10 m-auto py-20">
