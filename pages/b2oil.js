  ...
  return (
    <Layout title="B2 Oil">
      <div className="flex flex-col">
        ...
        <div className=" order-4 md:order-3 flex flex-col md:flex-row bg-gray-500 p-5">
        ...
        <div className="order-3 md:order-4 p-5 md:p-10 bg-gradient-to-br from-[#304e0e] to-[#4ab514b4] text-gray-100">
