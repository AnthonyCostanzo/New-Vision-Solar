  ...
  return (
    <Layout title="B2 Oil">
      <div className="flex flex-col">
        ...
        <div className="md:flex order-1 text-gray-200 bg-gradient-to-r from-[#db5c08] to-[#f67a22b4] p-10  shadow-sm shadow-gray-300">
          ...
          <p className="text-[20px] mt-3 ml-3 text-gray-7000 font-[Times]">
        ...
        <div className="order-4 p-10 bg-gradient-to-br from-[#304e0e] to-[#4ab514b4] text-gray-100">
