    ...
    <Layout>
      <section className="mt-3 p-5 md:flex-row flex-col flex flex-wrap gap-3 mb-10">
        ...
        <article className="md:order-3">
          ...
          <ul className="mt-1">
            <li>
              <span className="font-semibold">Natural Detergency </span>– As
              polar compounds, b2 biOil base oil has the unique ability to
              dissolve sludge and varnish, helping equipment stay clean and
              operate efficiently.
            </li>
            <li>
            ...
            <li>
              <span className="font-semibold">4-Ball Wear </span>– Base oils
              have an increased affinity for metal surfaces, allowing them to
              prevent wear by forming protective barriers between moving parts.
            </li>
            <li>
              <span className="font-semibold">Hydrolytic Stability </span> –
              Superior ability to resist chemical composition (hydrolysis) in
              the presence of water and ideal for applications whereby risk of
              water contamination is high
            </li>
            <li>
              <span className="font-semibold"> Evaporative Loss (NOACK) </span>–
              Reduced oil loss due to evaporation, viscosity is better
              maintained, fuel economy improves and increased phosphorous
              retention.
            </li>
            <li>
              <span className="font-bold"> Flash Point </span> – Ideal for
              applications where operating temperatures are high and
              flammability is a concern.
            </li>
            <li>
              <span className="font-bold"> Oxidative Stability </span> –
              Increased oil longevity for extended drain intervals, excellent
              response to antioxidant additives, less equipment downtime and
              reduced maintenance costs.
            </li>
            <li>
              <span className="font-bold"> Viscosity Index </span>– Enhanced
              film thickness at elevated temperatures, improved equipment life
              and reliability; and, reduced viscous drag on moving parts
              (minimal treat rates of viscosity modifiers).
            </li>
          </ul>
          <div className="h-96 w-11/12 hidden m-auto md:flex  relative my-10">
            <Image src="/images/pChart.png" alt=" " layout="fill" />
          </div>
        </article>
        <article className="md:order-3">
      ...
      <div className="h-96 w-11/12 m-auto md:flex  relative mb-14">
